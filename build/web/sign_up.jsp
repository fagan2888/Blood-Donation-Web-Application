<%-- 
    Document   : sign_up
    Created on : Feb 3, 2014, 1:07:57 PM
    Author     : Sachin
...
%>
        ...
        <form action="CheckCaptcha" method="post" name="myForm" onsubmit="return validateForm()">
            ...
            <pre> Name                   -->         <input class="input1" type="text" name="name" id="i1"></pre>
            
            <pre> City                       -->         <input class="input1" type="text" name="city" id="i2" ></pre>
            
            <pre> State                    -->         <input class="input1" type="text" name="state" id="i17" ></pre>
          
            <pre> E-Mail Id             -->         <input class="input1" type="text" name="email" id="i10"></pre>
            
            <pre> Password           -->          <input class="input1" type="password" name="pass" id="i4"></pre>
            
            <pre> Confirm              -->          <input class="input1" type="password" name="confirm" id="i5"></pre>
...
<select  class="input1" style="width:10%;float: right;margin-right: 30%;" name="year" id="i7">
 ...
 <select  class="input1" style="width:10%;float:right;" name="day" id="i7">
            ...
            <div style="margin-left:30%;height:20%;width:40%;font-size: 50px;font-family: Myriad Pro;background-color: #ff6666;">
                <center><%=cap%></center>
            </div>
            <br>
