<%-- 
    Document   : requestcredits
    Created on : 23 Apr, 2014, 1:25:40 PM
    Author     : SONY
--%>
<%
        ...
        <%
         ...
         <div style="position: relative;top:1%;left:9%;height:80%;width:80%;border: solid 2px #ccccff;padding:5px;border-radius: 10px;">
             ...
             <div style="padding-bottom: 20px;position:relative;left:4%;top:30%;">
                <form action="RequestCredits" method="post">
                    <pre>Enter email id of beneficiary    -    <input class="input1" type="text" name="bene_email"></pre>
